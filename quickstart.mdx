---
title: "How to Run EduPets Locally with FastAPI and Uvicorn"
sidebarTitle: "Quickstart"
description: "Set up and run EduPets on your local machine in under five minutes using Python 3.10+, pip, and the FastAPI standard development server."
---
