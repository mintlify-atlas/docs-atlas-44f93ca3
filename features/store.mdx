---
title: "In-Game Store: Cosmetic Items and Rewards"
sidebarTitle: "Store"
...
The store currently displays two product cards:

| Item | Price | Image source |
|---|---|---|
| Producto destacado | $9.99 | `cp.png` |
| Chamber | $800.99 | `Chamber.jpeg` |
...
The store page is built from standard semantic HTML inside `tienda.html`. Its top-level layout looks like this:
