...
<Steps>
  ...
  <Step title="Student returns to the pet dashboard">
    Back on the main screen, the child can see their pet looking healthy and happy again — reinforcing the connection between practice and positive outcomes.
  </Step>
</Steps>
