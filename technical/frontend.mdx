---
title: "Frontend Architecture: Vanilla JS, CSS, and Jinja2 Templates"
...
Each page loads exactly one JS file responsible for all the interactivity on that page. Files are not shared between pages (except `script.js` on the info pages).
...
| `script.js` | Info pages | Shared canvas animation utility used on informational pages |
